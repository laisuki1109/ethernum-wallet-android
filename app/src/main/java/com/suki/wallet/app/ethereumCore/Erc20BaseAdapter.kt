...
open class Erc20BaseAdapter(
    ...
    private fun convertToEthereumKitSyncState(syncState: EthereumKit.SyncState): EthereumKit.SyncState {
        return when (syncState) {
            is EthereumKit.SyncState.Synced -> EthereumKit.SyncState.Synced()
            is EthereumKit.SyncState.Syncing -> EthereumKit.SyncState.Syncing()
            is EthereumKit.SyncState.NotSynced -> EthereumKit.SyncState.NotSynced(syncState.error)
        }
    }
